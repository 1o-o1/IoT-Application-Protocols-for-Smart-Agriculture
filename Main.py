# -*- coding: utf-8 -*-
"""
Created on Wed Oct 20 23:54:28 2021
...
#number_host= int(input("Enter number of host: "))
...
message_len = 200
number_msg = 100
msg = np.random.randint(10001,size=(message_len ));

def MQTT():
    latency_m = (message_len**1.5)/45698+23+message_len/456
    latency_s = number_sub/(number_sub**0.5)+19
    latency = latency_m*latency_s;
    thro = number_msg- number_msg*0.03
    return latency,thro
